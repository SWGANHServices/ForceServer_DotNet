namespace SwgAnh.Docker.Constant
{
    public static class Constants
    {
        public static class LoginServer
        {
            public const int MaxPacketSize = 496;
            public const int LoginServerString = 0x0E20D7E9;
            public const int LoginServerId = 0x58C07F21;
            public const string LoginServerInfo = "LoginServer:29411";
            public const int LoginClientId = 0x41131F96; // You're Login Server
            public const int LoginClientToken = unchecked((int)0xAAB296C6);
            public const int LoginEnumCluster = unchecked((int)0xC11C63B9);



            public static uint[] CrcTable = { 0x00000000, 0x77073096,
